...
from lib.diary.manager import DiaryManager
...
def get_diary_router(current_user, logger):
    ...
    async def get_procedures(user: User = Depends(current_user)):
        pass
    ...
    async def update_procedure(procedure: FactProcedureUpdate,
                               procedure_id: int,
                               user: User = Depends(current_user)):
        pass
